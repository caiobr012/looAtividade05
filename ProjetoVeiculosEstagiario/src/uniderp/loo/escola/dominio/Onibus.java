...
public class Onibus  extends BaseVeiculoTransporte{
    
    private String empresa;
    private int codigoItinierario;
    ...
    public int getCodigoItinierario() {
        return codigoItinierario;
    }
    public void setCodigoItinierario(int codigoItinierario) {
        this.codigoItinierario = codigoItinierario;
    }

    public Onibus(int codigo, String nome, String fabricante, String modelo, String cor, String chassi,
            ...
            double potencia, String placa, String codigoRenavam, int roda, int eixo, int porta, String empresa,
            int codigoItinierario) {
    ...
    public void Imprime() {
        ...
        System.out.println("Código do Itinerário: " + this.codigoItinierario);
    }
}
